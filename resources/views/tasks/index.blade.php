    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex">
                    <a href="{{ route('tasks.create') }}" class="btn btn-primary mb-3 ms-auto">Add Task</a>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if($task->status == 'pending')
                                <a href="{{ route('tasks.markAsDone', $task->id) }}" class="btn btn-success btn-sm">Mark as Done</a>
                                @else
                                <a href="{{ route('tasks.markAsPending', $task->id) }}" class="btn btn-warning btn-sm">Mark as Pending</a>
                                @endif
