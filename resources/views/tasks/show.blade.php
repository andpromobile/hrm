    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p><strong>Assigned To:</strong> {{ $task->assigned_to ? $task->assignedEmployee->full_name : 'Unassigned' }}</p>
                <p><strong>Due Date:</strong> {{ \Carbon\Carbon::parse($task->due_date)->format('Y-m-d H:i') }}</p>
